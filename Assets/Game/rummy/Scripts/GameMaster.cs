...
namespace rummy
{
    ...
    public class GameMaster : MonoBehaviour
    {
        ...
        private static readonly Vector3 LD = new(-26, -10, 0);
        private static readonly Vector3 LU = new(-26, 7, 0);
        private static readonly Vector3 PL = new(-1.8f, -14f, 0);
        private static readonly Vector3 CU = new(-14.3f, 10, 0);
        private static readonly Vector3 CD = new(-14.3f, -14f, 0);
        private static readonly Vector3 RU = new(-1.61f, 10, 0);
        private static readonly Vector3 LM = new(-29, -1.8f, 0);
        private static readonly Vector3 FIU = new(-18, 9, 0);
        private static readonly Vector3 FID = new(-18, -13, 0);
        private static readonly Vector3 FD = new(-21, -13.25f, 0);
        private static readonly Vector3 FU = new(-21, 9.25f, 0);

        private readonly IDictionary<int, List<Vector3>> PlayerPos = new Dictionary<int, List<Vector3>>()
        {
            {2, new List<Vector3> { PL, RU } },
            {3, new List<Vector3> { PL, LM, RU } },
            {4, new List<Vector3> { PL, FD, FU, RU } },
            {5, new List<Vector3> { PL, FID, LM, FIU, RU } },
            {6, new List<Vector3> { PL, CD, LD, LU, CU, RU } }
        };
