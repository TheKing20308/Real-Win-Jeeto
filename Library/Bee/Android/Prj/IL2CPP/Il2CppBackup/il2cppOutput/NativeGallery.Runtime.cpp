...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR int32_t NativeGallery_RequestPermission_mC51543076B5983614D052B63C67AE676C9183499 (bool ___0_readPermissionOnly, const RuntimeMethod* method) ;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR int32_t NativeGallery_CheckPermission_mF2E5474DEBC30301614F3DCF901DB744EB3E724A (bool ___0_readPermissionOnly, const RuntimeMethod* method) 
{
	static bool s_Il2CppMethodInitialized;
	if (!s_Il2CppMethodInitialized)
	{
		...
		{// begin try (depth: 1)
			{
				...
				bool L_14 = ___0_readPermissionOnly;
				bool L_15 = L_14;
...
IL_0017:
	{
		...
		NullCheck(L_4);
		bool L_5;
		L_5 = String_EndsWith_mCD3754F5401E19CE7821CD398986E4EAA6AD87DC(L_4, _stringLiteral4B9B40AAD718882F5C0B95FE844E4AA92BD49C42, NULL);
		if (L_5)
		{
			goto IL_0031;
		}
	}
	{
		...
		NullCheck(L_6);
		bool L_7;
		L_7 = String_EndsWith_mCD3754F5401E19CE7821CD398986E4EAA6AD87DC(L_6, _stringLiteral23DF9991B71463C240582D176E347E7E47AEFF5A, NULL);
		G_B5_0 = ((int32_t)(L_7));
		goto IL_0032;
	}
...
IL_0049:
	{
		...
		NullCheck(L_15);
		bool L_16;
		L_16 = String_EndsWith_mCD3754F5401E19CE7821CD398986E4EAA6AD87DC(L_15, _stringLiteralA15C898F015A9B0BC3268E8883CD03008A56DE26, NULL);
		V_3 = L_16;
		bool L_17 = V_3;
		if (!L_17)
		{
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR int32_t NativeGallery_SaveToGallery_mAD9820FA0C518D117A499DC5D99BF99D240C4454 (ByteU5BU5D_tA6237BF417AE52AD70CFB4EF24A7A82613DF9031* ___0_mediaBytes, String_t* ___1_album, String_t* ___2_filename, int32_t ___3_mediaType, MediaSaveCallback_tEAA0B6F692AE0F92C02E21CDDB75ADFF4D89CD1D* ___4_callback, const RuntimeMethod* method) 
{
	...
	int32_t G_B14_0 = 0;
	{
		...
		int32_t L_0;
		L_0 = NativeGallery_RequestPermission_mC51543076B5983614D052B63C67AE676C9183499((bool)0, NULL);
		V_0 = L_0;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR int32_t NativeGallery_GetMediaFromGallery_mE04A8BFF146401DA572B17485B97A88D11A509E1 (MediaPickCallback_tC207F6F3EEE18F64B03E23D5C9FA8C79517A5EB6* ___0_callback, int32_t ___1_mediaType, String_t* ___2_mime, String_t* ___3_title, const RuntimeMethod* method) 
{
	...
	int32_t G_B3_0 = 0;
	{
		...
		int32_t L_0;
		L_0 = NativeGallery_RequestPermission_mC51543076B5983614D052B63C67AE676C9183499((bool)1, NULL);
		V_0 = L_0;
...
IL_00b7_2:
				{
					...
					L_33 = ImageConversion_EncodeToJPG_mD0307B5DFF32A3FF39488E97B467F11AFE501F6F(L_32, ((int32_t)100), NULL);
					G_B9_0 = L_33;
				}
...
// UnityEngine.Texture2D NativeGallery::GetVideoThumbnail(System.String,System.Int32,System.Double)
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR Texture2D_tE6505BC111DD8A424A9DBE8E05D7D09E11FFFCF4* NativeGallery_GetVideoThumbnail_m8C8C270121D84A8704F100E7F4FE9444066E1B24 (String_t* ___0_videoPath, int32_t ___1_maxSize, double ___2_captureTimeInSeconds, const RuntimeMethod* method) 
{
	static bool s_Il2CppMethodInitialized;
	if (!s_Il2CppMethodInitialized)
	{
...
IL_0013:
	...
	}
	{
		...
		L_29 = NativeGallery_LoadImageAtPath_m62187A34B7B063FBEFFD7E200DEC2332313A56AE(L_27, L_28, (bool)1, (bool)1, (bool)0, NULL);
		V_3 = L_29;
		goto IL_0080;
	}
...
IL_0111:
	{
		...
		int64_t L_49 = V_3;
		float L_50 = V_4;
		VideoProperties_t11DD7C4EACACE50EA3D710F3E2595A68B17103A5 L_51;
		memset((&L_51), 0, sizeof(L_51));
		VideoProperties__ctor_mF5D60E1ACB2B90A080BDB94C6362E49F835B2BFD((&L_51), L_47, L_48, L_49, L_50, /*hidden argument*/NULL);
		V_14 = L_51;
		goto IL_011f;
	}
...
IL_011f:
	{
		// }
		VideoProperties_t11DD7C4EACACE50EA3D710F3E2595A68B17103A5 L_52 = V_14;
		return L_52;
	}
}
#ifdef __clang__
		...
		{// begin try (depth: 1)
			{
				...
				V_1 = (bool)((!(((RuntimeObject*)(MediaPickCallback_tC207F6F3EEE18F64B03E23D5C9FA8C79517A5EB6*)L_4) <= ((RuntimeObject*)(RuntimeObject*)NULL)))? 1 : 0);
				bool L_5 = V_1;
				if (!L_5)
				{
					goto IL_002a_1;
			...
			{
				// callback( path );
				MediaPickCallback_tC207F6F3EEE18F64B03E23D5C9FA8C79517A5EB6* L_6 = __this->___callback_4;
		...
		{// begin try (depth: 1)
			{
				...
				V_1 = (bool)((!(((RuntimeObject*)(MediaPickMultipleCallback_t717A5D378751E2CACB53E6BA25386FF8DB41627B*)L_4) <= ((RuntimeObject*)(RuntimeObject*)NULL)))? 1 : 0);
				bool L_5 = V_1;
				if (!L_5)
				{
					goto IL_002f_1;
			...
			}
			{
				...
				MediaPickMultipleCallback_t717A5D378751E2CACB53E6BA25386FF8DB41627B* L_6 = __this->___callbackMultiple_5;
				StringU5BU5D_t7674CD946EC0CE7B3AE0BE70E6EE85F2ECD9F248* L_7 = ___0_paths;
				NullCheck(L_6);
